  ...
  return (
    <SafeAreaView style={SafeDrawerAndroidView.AndroidSafeArea}>
        <View style={tw`flex-row pb-3 items-center mx-4`}>
            ...
            <IconCommunity name='book-information-variant' size={iconSize} color='black' />
            </TouchableOpacity>
            ...
            <Text allowFontScaling={false} style={{fontSize: lgFontSize, fontWeight:'bold', color:'#eb1a22', paddingLeft: 5}}>Informazioni generali</Text>
            </View>
