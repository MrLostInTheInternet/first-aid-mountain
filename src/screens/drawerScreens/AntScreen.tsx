      ...
      <SafeAreaView style={SafeDrawerAndroidView.AndroidSafeArea}>
          <View style={tw`flex-row pb-3 items-center mx-4`}>
              ...
              <View style={tw`flex-1`}>
                ...
                <Text allowFontScaling={false} style={{fontSize: lgFontSize, fontWeight:'bold', color:'#eb1a22', paddingLeft: 5}}>Puntura da Imenottero</Text>
              </View>
            ...
            <View style={tw`items-center mx-4 flex-1 justify-center flex`}>
                ...
                <View style={tw`flex-row mt-5`}>
                    <TouchableOpacity activeOpacity={0} style={tw`mx-[5%] bg-red-500 p-2 px-5 rounded-xl shadow-2xl`} onPress={() => renderYes()}>
                        <Text allowFontScaling={false} style={{fontSize: xlFontSize, fontWeight:'bold', color:'white', textAlign:'center', marginHorizontal:7}}>Si</Text>
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={0} style={tw`mx-[5%] bg-green-500 p-2 rounded-xl shadow-2xl`} onPress={() => renderNot()}>
                        <Text allowFontScaling={false} style={{fontSize: xlFontSize, fontWeight:'bold', color:'white', textAlign:'center', marginHorizontal:7}}>No</Text>
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={0} style={tw`mx-[5%] bg-yellow-300 pt-2 pb-2 rounded-xl shadow-2xl`} onPress={() => renderIdk()}>
                        <Text allowFontScaling={false} style={{fontSize: xlFontSize, fontWeight:'bold', color:'black', textAlign:'center', marginHorizontal:7}}>Non lo so</Text>
                    </TouchableOpacity>
                </View>
            </View>)}
          ...
          {!allergicYes && !allergicIdk && allergicNot && ( // ALLERGIC NOT PAGE
            <View style={tw`items-center flex-1 justify-center`}>
                ...
                <View style={tw`bg-green-500 w-[90%] p-2 justify-center rounded-3xl shadow-2xl mx-[10%]`}>
                    ...
                    <Text allowFontScaling={false} style={{fontSize: lgFontSize, fontWeight:'bold', color:'red', textAlign:'center', backgroundColor:'white', borderRadius:15, padding:5}}>Utilizza pinzette o oggetti simili, il pungiglione va sollevato [ ! ]</Text>
                </View>
            </View>)}
            ...
            <View style={tw`items-center flex-1 justify-center`}>
                ...
                <View style={tw`bg-yellow-500 w-[90%] p-2 justify-center rounded-3xl shadow-2xl mx-[1%]`}>
                    ...
                    <Text allowFontScaling={false} style={{fontSize: lgFontSize, fontWeight:'bold', color:'white'}}>• ALTERAZIONE FREQUENZA CARDIACA</Text>
                </View>
                <View style={tw`flex-row mt-2 items-center justify-center`}>
                    <TouchableOpacity activeOpacity={0} style={tw`mx-[10%] bg-red-500 p-2 px-5 rounded-xl shadow-2xl`} onPress={() => renderYesIdkPage()}>
                        <Text allowFontScaling={false} style={{fontSize: xlFontSize, fontWeight:'bold', color:'white', textAlign:'center', marginHorizontal: 20}}>Si</Text>
                    </TouchableOpacity>
