    ...
    <SafeAreaView style={SafeDrawerAndroidView.AndroidSafeArea}>
        <View style={tw`flex-row pb-3 items-center mx-4`}>
            <TouchableOpacity activeOpacity={0}>
                <IconCommunity name='help' size={iconSize} color='black' />
            </TouchableOpacity>
            <View style={tw`flex-1`}>
                ...
                <Text allowFontScaling={false} style={{fontSize: lgFontSize, fontWeight:'bold', color:'#eb1a22', paddingLeft: 5}}>Supporto Tecnico</Text>
            </View>
